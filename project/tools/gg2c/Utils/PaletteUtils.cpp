...
void PaletteUtils::GetPaletteData(HPALETTE hPalette, PALETTEENTRY* paletteEntries)
{
...
void WritePaletteSourceFile(HPALETTE palette, const std::string& outputFolder, const std::string& outputName)
{
    ...
    PaletteUtils::GetPaletteData(palette, paletteEntries);
...
void PaletteUtils::WritePalette(HPALETTE palette, const std::string& outputFolder, const std::string& outputName)
{
