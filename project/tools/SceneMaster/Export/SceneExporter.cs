...
namespace SceneMaster.Export
{
    internal class SceneExporter
    {
        ...
        private static void ExportHeader(Scene scene, string sceneName, string destinationFolder)
        {
            ...
            sb.AppendLine();
            sb.AppendLine("#include \"engine\\scene_types.h\"");
            sb.AppendLine();
                                                   ...
                                                   IEnumerable<EditorObject> editorObjects)
        {
            ...
            {
                string backgroundResourceName = Path.GetFileNameWithoutExtension(scene.ForegroundMapPath) + "_map";
                                           ...
                                           Dictionary<EditorObject, ExportedCommandData> exportedCommandDatas)
        {
            ...
            sb.AppendLine("    { 0, (CommandFunction)ObjectManager_CreateObjectByCreateInfo, &" + sceneName + "_createInfoBootstrapper },");
