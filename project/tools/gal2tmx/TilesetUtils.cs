...
namespace gal2tmx
{
    internal class TilesetUtils
    {
                                        ...
                                        bool animated)
        {
            ...
            stringBuilder.AppendLine("#include \"engine\\map_types.h\"");

            stringBuilder.AppendLine("");

            if (animated)
                stringBuilder.AppendLine("RESOURCE() extern const Ruby_AnimatedTileset " + tilesetName + ";");
            else
                stringBuilder.AppendLine("RESOURCE() extern const Ruby_Tileset " + tilesetName + ";");
        ...
        */
                                               ...
                                               bool isBreakable)
        {
            ...
            stringBuilder.AppendLine();
            stringBuilder.AppendLine("RESOURCE() const Ruby_Tileset " + tilesetName + " = ");
            stringBuilder.AppendLine("{");
                                                       ...
                                                       bool isBreakable)
        {
            ...
            stringBuilder.AppendLine();
            stringBuilder.AppendLine("RESOURCE() const Ruby_AnimatedTileset " + tilesetName + " = ");
            stringBuilder.AppendLine("{");
                                        ...
                                        bool isBreakable)
        {
            ...
            stringBuilder.AppendLine("#include \"engine\\resource_types.h\"");
            stringBuilder.AppendLine("");
